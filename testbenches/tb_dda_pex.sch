...
C {devices/isource.sym} -500 300 2 0 {name=I0 value=2.3u}
C {devices/gnd.sym} -500 350 0 0 {name=l5 lab=GND}
...
C {devices/code_shown.sym} -800 390 0 0 {name=DUT only_toplevel=true
format="tcleval( @value )"
value="

.include /home/gmaranhao/Desktop/sky130_work/INA_layout_v2/pex/ina_top_pex.spice
*.include /home/gmaranhao/Desktop/sky130_work/INA_layout_v2/lvs_ina_top/ina_top_lay.spice

* ina_top VCM VI_1B IREF VI_1A VO2 VO1 VI_2A VI_2B AVDD AVSS

X1 vcm vin2 iref vin1 vo2 vo1 vx vy vdd vss ina_top

"}
C {devices/lab_wire.sym} -480 270 0 1 {name=p1 sig_type=std_logic lab=iref}
